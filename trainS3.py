from utils import S3_data_to_list, create_generators
...
# AWS SECURITY KEYS
ap.add_argument("--aws_region", type=str, default='ap-south-1',
                help="AWS Region Name")
ap.add_argument("--aws_access_key_id", type=str, required=True,
                help="AWS Access Key ID")
ap.add_argument("--aws_sec_access_key", type=str, required=True,
...
aws_sec_access_key = args['aws_sec_access_key']

###################### SECURITY KEYS ######################
os.environ["AWS_DEFAULT_REGION"] = aws_region
os.environ["AWS_ACCESS_KEY_ID"] = aws_access_key_id
os.environ["AWS_SECRET_ACCESS_KEY"] = aws_sec_access_key
###########################################################
